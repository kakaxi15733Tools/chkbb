...
<head>
        ...
        <div class="col-md-8">
          <div class="card">
            <div class="card-body text-center">
              <h4 class="title mb-2">CHK GERADAS BB1</h4>
              <h5  style="font-family: 'Trebuchet MS', sans-serif; font-size: 20px;"><i class="fas fa-fire"></i> FLUXO 171 <i class="fas fa-fire"></i> </h5>
 ...
 <b> Whats:</b> <a href="https://wa.me/+5592993034057?text=100$ api de checker "> <b><font color="danger">@ESTORNO</font></b></a> </i> <b> telegram:</b> <a href="http://telegram.me/ESTORNO"> <b><font color="danger">@ESTORNO</font></b></a>
      ...
      line.forEach(function(data) {
        var callBack = $.ajax({
          ...
          success: function(retorno) {
            if (retorno.indexOf("aprovadas") >= 0) {
              live.play();
              Swal.fire({
